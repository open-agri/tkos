...
#define LV_THEME_DEFAULT_COLOR_PRIMARY      lv_color_hex(0xfa8231)
#define LV_THEME_DEFAULT_COLOR_SECONDARY    lv_color_hex(0xfd9644)
#define LV_THEME_DEFAULT_FLAG               LV_THEME_MATERIAL_FLAG_DARK
#define LV_THEME_DEFAULT_FONT_SMALL         &nunito_bold_12
#define LV_THEME_DEFAULT_FONT_NORMAL        &nunito_bold_16
