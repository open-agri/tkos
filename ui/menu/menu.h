...
typedef struct tk_menu_item {
  ...
  /**
   * @brief Called when a button is selected in a list or its value changed (for
   * other widgets).
   *
   */
...
#define TK_MENU_VALUE_CHANGE_CB_DECLARE(name)                                  \
  static void name(tk_menu_item_t *sender)
#define TK_MENU_FOCUS_CHANGE_CB_DECLARE(name)                                  \
  static void name(tk_menu_item_t *focused)
